...
import com.rvks.pom.util.TestUtil;
import com.rvks.pom.util.WebEventListener;
	...
	public TestBase() {
		try {
			...
			FileInputStream ip = new FileInputStream(
					System.getProperty("user.dir") + "/src/main/java/com/rvks"
							+ "/pom/config/config.properties");
			prop.load(ip);
